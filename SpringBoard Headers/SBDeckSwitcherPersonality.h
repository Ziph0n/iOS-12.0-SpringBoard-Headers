...
@interface SBDeckSwitcherPersonality : NSObject <_UISettingsKeyObserver, SBFluidSwitcherPersonality>
{
    ...
    _Bool _hadOpenFolderWhenGestureBegan;
...
@property(readonly, nonatomic) _Bool hadOpenFolderWhenGestureBegan; // @synthesize hadOpenFolderWhenGestureBegan=_hadOpenFolderWhenGestureBegan;
