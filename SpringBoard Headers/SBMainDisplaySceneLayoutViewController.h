...
@class FBUIApplicationSceneDeactivationAssertion, NSArray, NSMutableSet, NSString, SBHomeGrabberRotationView, SBHomeGrabberSettings, SBHomeGrabberView, SBMainDisplayLayoutState, SBMainDisplaySceneLayoutDropInteractionManager, SBMainDisplaySceneLayoutGestureManager, SBOrientationTransformWrapperView, SBSceneHandleBlockObserver, SBSeparatorView, SBUIKeyboardHomeAffordanceAssertion, UIApplicationSceneClientSettingsDiffInspector, UIStatusBar, UIView;

@interface SBMainDisplaySceneLayoutViewController : SBSceneLayoutViewController <_UISettingsKeyObserver>
{
    ...
    _Bool _autoHidingHomeGrabber;
    _Bool _isKeyboardShowing;
    _Bool _isMedusaKeyboard;
    _Bool _isSuppressingKeyboard;
...
- (void)_updateHomeGrabberEdgeProtect;
- (void)_updateHomeGrabberAutoHideWithResetDelay:(double)arg1 unhideDelay:(double)arg2;
...
- (void)_keyboardSuppressionDidStop:(id)arg1;
- (void)_keyboardSuppressionDidStart:(id)arg1;
- (void)_keyboardWillHide:(id)arg1;
- (void)_keyboardWillShow:(id)arg1;
- (void)_noteKeyboardBelongsToMedusaApp:(_Bool)arg1;
