...
@class CoreTelephonyClient, NSArray, NSObject<OS_dispatch_queue>, NSString, NWSystemPathMonitor, SBAirplaneModeController, SBAlertItem, SBTelephonySubscriptionContext, TUCall;
...
- (id)_dataConnectedSubscriptionContextIfSIMPresent;
...
@property(readonly, nonatomic, getter=isDataConnectionBlockedByCall) _Bool dataConnectionBlockedByCall;
