...
@class BSTimer, NSHashTable, NSString, SBHomeGestureSettings, SBViewMorphAnimatorContentClippingView, UIView;
...
- (void).cxx_destruct;
- (void)_handleHandoffTimeout:(CDUnknownBlockType)arg1;
