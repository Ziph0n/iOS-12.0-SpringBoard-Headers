...
@interface SBFluidSwitcherAnimationSettings : SBUISettings
{
    ...
    SBFluidBehaviorSettings *_switcherFadeOutDuringFolderExpansionSettings;
...
@property(retain, nonatomic) SBFluidBehaviorSettings *switcherFadeOutDuringFolderExpansionSettings; // @synthesize switcherFadeOutDuringFolderExpansionSettings=_switcherFadeOutDuringFolderExpansionSettings;
