...
@class NSString, SBAppLayout, SBAppSwitcherPageView, SBAppSwitcherSettings, SBFailureNotifyingTapGestureRecognizer, SBFluidBehaviorSettings, SBFluidSwitcherIconOverlayView, SBFluidSwitcherItemContainerHeaderView, UILongPressGestureRecognizer, UIScrollView, UITapGestureRecognizer, UIView<SBAppSwitcherPageContentView>;
