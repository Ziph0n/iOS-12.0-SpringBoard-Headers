...
@class NSString, SBApplicationSceneViewStatusBarDescriptor, SBDeviceApplicationSceneHandle, SBHomeGrabberRotationView, SBHomeGrabberSettings, SBHomeGrabberView, SBSceneHandleBlockObserver, UIApplicationSceneClientSettingsDiffInspector, UIView, UIView<SBApplicationSceneBackgroundView>;
