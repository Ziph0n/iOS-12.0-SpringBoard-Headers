...
@class BSSimpleAssertion, DNDEventBehaviorResolutionService, FBUIApplicationSceneDeactivationAssertion, NCNotificationManagementViewPresenter, NCNotificationViewController, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSObject<OS_dispatch_source>, NSString, SBAppStatusBarSettingsAssertion, SBAssistantController, SBLockScreenManager, SBNotificationBannerWindow, SBNotificationLongLookBannerDestination, SBSetupManager;
...
- (void)dismissPresentedBannerAnimated:(_Bool)arg1 forceIfSticky:(_Bool)arg2 silenceIfSticky:(_Bool)arg3;
