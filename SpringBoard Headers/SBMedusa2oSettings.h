...
@interface SBMedusa2oSettings : SBUISettings
{
    ...
    double _compatibilityAppBottomInset;
    double _compatibilityAppTopInset;
}

+ (id)settingsControllerModule;
@property(nonatomic) double compatibilityAppTopInset; // @synthesize compatibilityAppTopInset=_compatibilityAppTopInset;
@property(nonatomic) double compatibilityAppBottomInset; // @synthesize compatibilityAppBottomInset=_compatibilityAppBottomInset;
