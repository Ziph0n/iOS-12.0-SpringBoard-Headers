...
@class NSHashTable, NSMapTable, NSMutableSet, NSString, SBFWallpaperConfigurationManager, SBFWallpaperSettings, SBFWallpaperView, SBRootSettings, SBWallpaperAggdLogger, SBWallpaperStyleInfo, UIImage, UIScreen, UIView, UIView<SBUIWallpaperOverlay>, UIWindow;
